...
import (
	...
	cachev1alpha1 "github.com/adeniyistephen/learnoperator/api/v1"
)
...
func (r *LearningReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	memcached := &cachev1alpha1.Learning{}
...
func (r *LearningReconciler) deploymentForMemcached(m *cachev1alpha1.Learning) *appsv1.Deployment {
